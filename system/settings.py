...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clubs.context_processors.get_clubs_user_belongs_to',
            ],
        },
    },
]
...
# Login URL for redirecting users any login purposes
LOGIN_URL = 'log_in'

# URL for @logged in prohibited
REDIRECT_URL_WHEN_LOGGED_IN = 'start'
